import unittest
from app import app, varasto_manager
...
class TestFlaskApp(unittest.TestCase):
    def setUp(self):
        ...
        varasto_manager._varastos.clear()
    ...
    def test_create_varasto_success(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn('TestVarasto', varasto_manager._varastos)
        self.assertEqual(varasto_manager._varastos['TestVarasto'].tilavuus, 100.0)
    ...
    def test_create_varasto_invalid_tilavuus(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertNotIn('BadVarasto', varasto_manager._varastos)
    ...
    def test_create_varasto_empty_name(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(varasto_manager._varastos), 0)
    ...
    def test_add_to_varasto_success(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(varasto_manager._varastos['TestVarasto'].saldo, 50.0)
    ...
    def test_add_negative_amount(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(varasto_manager._varastos['TestVarasto'].saldo, 0.0)
        self.assertIn(b'positiivinen', response.data)
    ...
    def test_take_from_varasto_success(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(varasto_manager._varastos['TestVarasto'].saldo, 30.0)
    ...
    def test_delete_varasto_success(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertNotIn('TestVarasto', varasto_manager._varastos)
    ...
    def test_multiple_varastos(self):
        ...
        self.assertEqual(len(varasto_manager._varastos), 3)
        
        # Add to different varastos
        self.client.post('/add/Varasto1', data={'maara': '50.0'})
        self.client.post('/add/Varasto2', data={'maara': '100.0'})
        
        self.assertEqual(varasto_manager._varastos['Varasto1'].saldo, 50.0)
        self.assertEqual(varasto_manager._varastos['Varasto2'].saldo, 100.0)
        self.assertEqual(varasto_manager._varastos['Varasto3'].saldo, 0.0)
        
        # Delete one varasto
        self.client.post('/delete/Varasto2')
        
        self.assertEqual(len(varasto_manager._varastos), 2)
        self.assertNotIn('Varasto2', varasto_manager._varastos)
    ...
    def test_add_overflow_handling(self):
        ...
        self.assertEqual(varasto_manager._varastos['TestVarasto'].saldo, 100.0)
